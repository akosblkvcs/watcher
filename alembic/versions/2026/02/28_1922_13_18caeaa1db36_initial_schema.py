...
def upgrade() -> None:
    ...
    sa.Column('processor_type', sa.String(length=50), server_default='raw_text', nullable=False),
    ...
    op.create_table('watch_observations',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_watch_observations_run_id'), 'watch_observations', ['run_id'], unique=False)
    op.create_index(op.f('ix_watch_observations_target_id'), 'watch_observations', ['target_id'], unique=False)
